...
>(({ index, className, ...props }, ref) => {
  ...
  return (
    <div
      ref={ref}
      className={cn(
        // Alterado: h-14 w-12 para ser maior, rounded-xl para combinar com os cards, e bordas individuais
        "relative flex h-14 w-12 items-center justify-center border border-input bg-background text-lg font-semibold transition-all rounded-xl shadow-sm",
